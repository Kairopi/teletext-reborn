...
describe('PageRouter', () => {
  ...
  describe('Quick Access Pages', () => {
    it('should have correct quick access mappings', () => {
      ...
      expect(QUICK_ACCESS_PAGES[4]).toBe(PAGE_NUMBERS.HOROSCOPES);  // Req 31.3
      expect(QUICK_ACCESS_PAGES[5]).toBe(PAGE_NUMBERS.TIME_MACHINE);
      expect(QUICK_ACCESS_PAGES[6]).toBe(PAGE_NUMBERS.TV_GUIDE);    // Req 31.4
